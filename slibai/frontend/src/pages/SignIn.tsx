...
import { signIn, googleLoginUrl, githubLoginUrl } from '../api/auth'
    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-slate-800 border border-slate-700 rounded-2xl p-8">
          {/* OAuth error banner */}
          {oauthError && (
            <div className="bg-red-900/30 border border-red-700 rounded-xl p-3 mb-5 text-red-400 text-sm text-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                ...
                <Link to="/forgot-password" className="text-indigo-400 text-xs hover:text-indigo-300">
                  Forgot password?
                </Link>
              </div>
              <input
