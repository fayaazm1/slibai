            ...
            <div className="relative" ref={menuRef}>
              ...
              >
                {(() => {
                  ...
                  return (
                    <div className={`w-7 h-7 rounded-full ${av.bg} flex items-center justify-center text-sm`}>
                      {av.id === 'default'
                ...
                <div className="absolute right-0 mt-2 w-56 bg-slate-800 border border-slate-700 rounded-xl shadow-2xl overflow-hidden">
                  ...
                  <div className="px-4 py-3 border-b border-slate-700 flex items-center gap-3">
                    {(() => {
                      const av = getAvatar(user.avatar_url)
                      return (
                        <div className={`w-9 h-9 rounded-xl ${av.bg} flex items-center justify-center text-lg shrink-0`}>
                          {av.id === 'default'
